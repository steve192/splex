...
- Follow `docs/error-handling.md` for API failures: domain services raise typed
  codes, DRF exceptions are mapped at the API boundary, and frontend display
  goes through the shared error resolver.
